...
class LecturerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lecturer
        fields = ['lecture_id','staffID','first_name','last_name','email','DOB','password']
...
class ClassSerializerLists(serializers.ModelSerializer):
    ...
    class Meta:
        model = Class
        fields = ['id','number','course','semesters','lecturer_details']
    
    def getsemesternames(self,obj):
        names = []
        for item in obj.course.semesters.all():
...
class LecturerSerializerLists(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lecturer
        fields = ['lecture_id','first_name','last_name','email','DOB','staffID','classLists','password']
